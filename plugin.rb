...
# about: Load-test routes for /shop and /shop/admin with multiple strategies and ultra-safe SSR (+ optional navbar inject)
# version: 0.0.3
# authors: LoadTestKit
...
after_initialize do
  ...
  when "ssr_prepend", "all_on"
    ...
    Discourse::Application.routes.prepend do
      ...
      get "/#{prefix}/ok" => "shop_loadtest/spa#ok"
  ...
  if %w[admin_plugins all_on].include?(strategy)
    ...
    Discourse::Application.routes.prepend do
      ...
      get '/admin/plugins/shop.json' => proc { |env| [200, { 'Content-Type' => 'application/json' }, ['{}']] }, constraints: StaffConstraint.new
    end
  end
